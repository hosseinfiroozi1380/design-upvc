    ...
    V = R.extend(
      ...
      })(),
      {
        _hitTest: function (i, e, t) {
          ...
          function f(t) {
            return (
              (t = t && l && !l(t) ? null : t) && e.all && e.all.push(t),
              t
            );
          }
          function d(t, e) {
    ...
    H = R.extend(
      ...
      new (function () {
        ...
        function b(t, e, n, i) {
          t = H.classify(t);
          return (
            "loop" === t.type && T(n, i, e, (t = t.roots)[0], e, t[1]),
            n
          );
        }
        function w(t, e) {
        ...
        function i(r, s, t) {
          ...
          for (; e <= n;) {
            ...
            if (t && (o = s.equals(u) ? u : i(h, -1) || i(h, 1)))
              return (
                s._overlap && (o._overlap = o._intersection._overlap = !0),
                o
              );
            var l = s.getPath(),
              c = u.getPath();
    ...
    W = _.extend(
      ...
      },
      {
        ...
        getPathData: function (n, t) {
          ...
          return (
            this._closed && 0 < c && (p(e[0], !0), g.push("z")),
            g.join("")
          );
        },
        isEmpty: function () {
    ...
    lt = new (function () {
      ...
      var k = {
          ...
          "color-dodge": function () {
            ((b =
              0 === m ? 0 : 255 === _ ? 255 : a(255, (255 * m) / (255 - _))),
              (C =
          ...
          function Oe() {
            switch (g) {
              ...
              case rt:
                ...
                return (
                  se(),
                  (t.elements = Le(st, !0, !0)),
                  ce(t, "ArrayExpression")
                );
              case at:
                return (function () {
                  var t = ue(),
