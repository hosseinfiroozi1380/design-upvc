(!(function (e, t) {
  ...
  var t = "SweetAlert2:",
    ...
    h = function (e) {
      var t = {};
      for (var n in e) t[e[n]] = "confirm" === e[n] ? "wd-right-confirm" : "swal2-" + e[n];
      return t;
    },
    _ = h([
      "container",
    ...
    oe = function (e) {
      ...
      if (e.type)
        if (-1 !== Object.keys(g).indexOf(e.type)) {
          var o = He.getPopup().querySelector(
      ...
      i.progressSteps && i.progressSteps.length
        ? (U(r),
          ...
          i.progressSteps.forEach(function (e, t) {
            ...
            if (
              (N(n, _.progresscircle),
                (n.innerHTML = e),
                t === a && N(n, _.activeprogressstep),
                r.appendChild(n),
  ...
  var pe = {
    ...
    be = function (e) {
      for (var t in e)
        (he(t) || q('Unknown parameter "'.concat(t, '"')),
          e.toast &&
          -1 !== me.indexOf(t) &&
  ...
  var we = [],
    ...
    Be = { promise: new Ae(), innerParams: new Ae(), domCache: new Ae() };
  function Se() {
  ...
  var Te = function (e) {
    ...
    (null !== e.onBeforeOpen &&
      ...
      e.onBeforeOpen(n),
      e.animation ? (N(n, _.show), N(t, _.fade), W(n, _.hide)) : W(n, _.fade),
      U(n),
      ...
      N([document.documentElement, document.body, t], _.shown),
      e.heightAuto &&
      e.backdrop &&
      !e.toast &&
      N([document.documentElement, document.body], _["height-auto"]),
      L() &&
      (se(),
        (function () {
          if (
      ...
      _main: function (e) {
        ...
        (!(function (t) {
          ...
          if (
            (ae(t),
              ...
              "string" == typeof t.backdrop
                ...
                : t.backdrop ||
                N([document.documentElement, document.body], _["no-backdrop"]),
              !t.backdrop &&
              t.allowOutsideClick &&
              q(
          ...
          ("function" == typeof t.animation &&
            ...
            (e.className = _.popup),
            t.toast
              ? (N([document.documentElement, document.body], _["toast-shown"]),
                N(e, _.toast))
              : N(e, _.modal),
            ...
            te(t),
            G(t.footer, u),
            !0 === t.animation ? W(e, _.noanimation) : N(e, _.noanimation),
        ...
        return new Promise(function (t, n) {
              ...
              switch (e.type) {
                case "click":
                  if (i && M.isVisible())
                    ...
                    r &&
                      M.isVisible() &&
                      (L.disableButtons(), c(M.DismissReason.cancel));
              }
            },
          ...
          (ce.keydownHandlerAdded &&
            ...
            T.toast && (T.input || T.footer || T.showCloseButton)
              ? N(document.body, _["toast-column"])
          ...
          switch (T.input) {
            ...
            case "url":
              ...
              break;
            case "file":
              (((d = z(j.content, _.file)).placeholder = T.inputPlaceholder),
                (d.type = T.input),
                U(d));
              break;
            case "range":
  ...
  var qe,
    ...
    He = de(
      ((qe = Ve),
        ...
        Re.setDefaults(window._swalDefaults),
        Re),
    );
