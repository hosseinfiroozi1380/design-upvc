...
!(function (t) {
  ...
  class T {
    ...
    pushLeftBeforeInput() {
      return this._pushLeft(() => {
        if (!this.block.isFixed)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, c)),
            !0
          );
      });
    }
    ...
    pushRightBeforeInput() {
      return this._pushRight(() => {
        if (!this.block.isFixed)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, h)),
            !0
          );
      });
    }
  ...
  class Ss extends ls {
    ...
    _handleSwipe() {
      ...
      ((this._deltaX = 0),
        e &&
          je(e > 0 ? this._config.rightCallback : this._config.leftCallback));
    }
    _initEvents() {
      this._supportPointerEvents
  ...
  class er extends us {
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", s),
        this._isAnimated() && e.classList.add(Un),
        e
      );
    }
    setContent(t) {
      ...
      for (const e of t)
        if ("click" === e)
          ...
          (is.on(this._element, t, this._config.selector, (t) => {
            ...
            ((e._activeTrigger["focusin" === t.type ? Zn : Qn] = !0),
              e._enter());
          }),
